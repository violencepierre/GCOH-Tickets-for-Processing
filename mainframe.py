...
def get_user_choice():
    while True:
        try:
            print("GCOH TASKKKKKKKKKKKKKKKKKKKKKKKKKKKKKKKKKKKKKSSSSSSSSSSSSSSSSSSSSS ASSISTANT AND OTHER STUFF PLEASE MAKE SURE YOU GIT PULL ALWAYS OR WE WILL HAVE ISSUES IF YOU WANT TO UPDATE THE CODE PLEASE SEND A PR DO NOT EDIT THE CODE YOURSELF PLEASE FOR THE LOVE OF GOD")
            print("GCOH TASKKKKKKKKKKKKKKKKKKKKKKKKKKKKKKKKKKKKKSSSSSSSSSSSSSSSSSSSSS ASSISTANT AND OTHER STUFF PLEASE MAKE SURE YOU GIT PULL ALWAYS OR WE WILL HAVE ISSUES IF YOU WANT TO UPDATE THE CODE PLEASE SEND A PR DO NOT EDIT THE CODE YOURSELF PLEASE FOR THE LOVE OF GOD")
            print("GCOH TASKKKKKKKKKKKKKKKKKKKKKKKKKKKKKKKKKKKKKSSSSSSSSSSSSSSSSSSSSS ASSISTANT AND OTHER STUFF PLEASE MAKE SURE YOU GIT PULL ALWAYS OR WE WILL HAVE ISSUES IF YOU WANT TO UPDATE THE CODE PLEASE SEND A PR DO NOT EDIT THE CODE YOURSELF PLEASE FOR THE LOVE OF GOD")
